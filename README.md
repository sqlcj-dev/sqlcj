...
schema it cannot parse, a query it cannot compile, an output directory or file
it cannot write, a stale generated file it cannot delete, or an output manifest
